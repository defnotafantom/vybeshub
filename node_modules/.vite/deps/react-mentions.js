...
var hoistModifierStylesRecursive = function hoistModifierStylesRecursive2(style, modifierKeysToPick) {
  var result = merge.apply(void 0, [{}, omit(style, modifierKeysToPick)].concat(_toConsumableArray2(values(pickNestedStyles(style, modifierKeysToPick)))));
...
var deriveClassNames = function deriveClassNames2(className, elementKeys, modifierKeys) {
  ...
  var derivedClassNames = [].concat(_toConsumableArray2(elementKeys.length === 0 ? modifierKeys.map(function(key) {
    return "".concat(firstClassName, "--").concat(key.substring(1));
  }) : []), _toConsumableArray2(elementKeys.map(function(key) {
    return "".concat(firstClassName, "__").concat(key);
  })));
  return elementKeys.length === 0 ? [className].concat(_toConsumableArray2(derivedClassNames)) : derivedClassNames;
};
function createSubstyle(_ref) {
  ...
  var substyle = typeof style === "function" ? style : memoize_default(function(select, defaultStyle2) {
    ...
    return createSubstyle(_objectSpread2(_objectSpread2(_objectSpread2({}, (style || defaultStyle2) && {
      style: merge.apply(void 0, [{}].concat(_toConsumableArray2(collectSelectedStyles(defaultStyle2)), _toConsumableArray2(collectSelectedStyles(style))))
    }), derivedClassNames && {
  ...
  var classNameSplit = _toConsumableArray2(new Set([].concat(_toConsumableArray2(styleProps.className ? styleProps.className.split(" ") : []), _toConsumableArray2(baseClassName ? baseClassName.split(" ") : []))));
